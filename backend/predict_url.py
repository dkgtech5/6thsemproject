...
def get_clean_domain(domain_str):
    ...
    return domain_str.split(':')[0].lower()
...
if __name__ == '__main__':
    ...
    elif ext.suffix in TRUSTED_TLD_SUFFIXES and not ext.subdomain:
        label = "LEGITIMATE"
        prob = [100.0, 0.0]
    # Rule 3: Invalid TLDs (e.g. google.com.a)
    elif not bool(ext.suffix):
        label = "PHISHING"
        prob = [0.0, 100.0]
    # Rule 4: Typo-squatted domains containing brand names (e.g. esewadkg.com.np)
